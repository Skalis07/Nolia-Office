...
- `!important` en Notion se mantiene en la mayoria de overrides de layout.
...
- El fondo del `body` en embed se resuelve por JS (`embed-notion.ts`) con `prefers-color-scheme`.
